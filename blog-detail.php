					...
					<nav class="main-menu navbar-expand-md">
						...
						<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
							<ul class="navigation clearfix">
								...
								<li><a href="services.php">Domaines</a>
								</li>
					...
					<div class="blog-detail">
						<div class="inner-box">
							<div class="image">
								...
								<ul class="post-meta">
									<li><span class="icon flaticon-timetable"></span>15 novembre, 2023</li>
									<li><span class="icon flaticon-email"></span>Comments 03</li>
									
								</ul>
							</div>
							<div class="lower-content">
								<h3>Titre de l'article: BIG DATA.</h3>
						...
						<div class="comment-form">
							...
							<div class="group-title"><h5>LAISSER UN COMMENTAIRE</h5></div>
							...
							<form method="post" action="blog.php">
								<div class="row clearfix">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 form-group">
										<textarea class="" name="message" placeholder="Votre Message"></textarea>
									</div>
